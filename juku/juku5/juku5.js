    ...
    function setup() {
        ...
        switch (p) {
            case 0:
                ...
                n2 = getRandom(4, 9);
                a = n1 * (n2 - 1);
                $mondai.innerText = `まっすぐな道に木を` + n1 + `ｍおきに` + n2 + `本うえました。りょうはしの木は何ｍはなれていますか?`;
                $unit.innerText = `ｍ`;
                break;
            case 1:
                n1 = getRandom(4, 9);
                a = getRandom(4, 9);
                n2 = n1 * (a - 1);
                $mondai.innerText = `まっすぐな道に木を` + n1 + `ｍおきにうえました。りょうはしの木が` + n2 + `ｍはなれている時、木は何本うえましたか?`;
                $unit.innerText = `本`;
                break;
            case 2:
                n1 = getRandom(4, 9);
                a = getRandom(4, 9);
                n2 = (n1 - 1) * a;
                $mondai.innerText = `まっすぐな道に同じかんかくで木を` + n1 + `本うえました。りょうはしの木が` + n2 + `ｍはなれている時、木は何ｍおきにうえましたか?`;
                $unit.innerText = `ｍ`;
                break;
            default:
                alert(`リロードして下さい`);
